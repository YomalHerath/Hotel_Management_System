...
<!DOCTYPE html>
<html>
	<!-- get all room details with request -->
	<% List<Rooms> listRooms = (List<Rooms>) request.getAttribute("listRooms"); %>
<head>
...
<body>
	...
	<div class="row">
        ...
        <!-- create table view to show all room details -->  
        <table class="table table-striped" border="1" style="background-color:white">
            ...
            <tbody>
            	...
            	<!-- list all room details in database with for each loop -->
	            <c:forEach var="rooms" items="${listRooms}">
	            <tr>
