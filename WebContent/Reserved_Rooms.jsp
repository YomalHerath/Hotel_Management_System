...
<html>
	...
	<% List<Reservation> listReservedRooms = (List<Reservation>) request.getAttribute("listReservedRooms"); %>
<head>
...
<body>
	...
	%>
  	...
  	<div class="container">
        ...
        <!-- create table view to show reserved room details -->  
        <table class="table table-striped" border="1" style="background-color:white">
            ...
            <tbody>
	            ...
	            <c:forEach var="listReservedRooms" items="${listReservedRooms}" >
